...
<style>
	...
	.sheet{position:relative;width:min(520px,100%);max-height:calc(100dvh - 32px);overflow:auto;padding:clamp(26px,5vw,46px);border:1px solid var(--glass-border);border-radius:36px;background:linear-gradient(145deg,rgba(255,255,255,.2),transparent 52%),var(--bg-elevated);box-shadow:0 30px 100px rgba(0,0,0,.2),inset 0 1px rgba(255,255,255,.35);backdrop-filter:blur(32px) saturate(170%);-webkit-backdrop-filter:blur(32px) saturate(170%)}
	.brand{display:flex;align-items:center;gap:9px;font-weight:760}.brand span{width:38px;height:38px;display:grid;place-items:center;border:1px solid rgba(255,255,255,.45);border-radius:13px;color:var(--on-brand);background:linear-gradient(145deg,#759fc6,var(--brand-strong));box-shadow:0 10px 28px color-mix(in srgb,var(--blue) 30%,transparent),inset 0 1px rgba(255,255,255,.58)}
